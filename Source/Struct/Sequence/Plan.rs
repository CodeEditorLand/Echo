...
impl Struct {
	...
	pub fn WithSignature(mut self, Signature: crate::Struct::Sequence::Action::Signature::Struct) -> Self {
	...
	where
		...
		Fut: Future<Output = Result<serde_json::Value, crate::Enum::Sequence::Action::Error::Enum>> + Send + 'static,
	{
